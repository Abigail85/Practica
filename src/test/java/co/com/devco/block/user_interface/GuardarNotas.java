...
public class GuardarNotas {
	...
	public static final Target BUTTON_GUARDAR_NOTA_CON_FORMATO = Target.the("espacio para guardar la nota con formato").located(By.xpath("//button[@class='btn save-file-btn saveNotesBtn richtextnoteBtn']"));//div[@id='richtextnote']//following::button"));
